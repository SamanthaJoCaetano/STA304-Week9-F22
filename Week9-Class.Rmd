...
# Fill in the blanks to simulate the variables

unique_person_id =   # id variable, different for each person

age =    # age variable (lets keep it numeric and say 18+)
...
# Let's do the same with city. Create city_num such that Toronto=3, Montreal=2 and Calgary=1
